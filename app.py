...
from Python import AMPnet_functions
...
def process_text():
    try:
        ...
        user_text_df['Padded_One_Hot'] = user_text_df['One_Hot_Encoded'].apply(lambda arr_list: AMPnet_functions.pad_arrays(arr_list, max_length))
